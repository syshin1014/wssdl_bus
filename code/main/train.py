...
# using combined mini-batches from supervised and weakly supervised sets.
# coded by syshin

import _init_paths
from fast_rcnn.train_bus import get_training_roidb, train_net
...
def parse_args():
    ...
    parser.add_argument('--network', help='name of the network', default='VGGnet_train', type=str)
    ...
    parser.add_argument('--imdb_test', help='test set', default='bus_test', type=str) # bus_test
...
if __name__ == '__main__':
    ...
    train_net(network, imdb_train_s, roidb_train_s, imdb_train_ws, roidb_train_ws, imdb_test, roidb_test, args.output_dir,
